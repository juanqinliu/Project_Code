...
# Register the custom model class with ultralytics' tasks module to allow torch.load to find it.
try:
    import ultralytics.nn.tasks
    if not hasattr(ultralytics.nn.tasks, 'MotionDetectionModel'):
        ultralytics.nn.tasks.MotionDetectionModel = MotionDetectionModel
        print("INFO: Registered custom 'MotionDetectionModel' with ultralytics.nn.tasks.")
except Exception as e:
    print(f"WARNING: Could not register MotionDetectionModel: {e}")
    print("         This may cause issues when loading motion detection models.")
